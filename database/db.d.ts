...
interface WherePost {
  post_id?: number | Array<number>;
  image_url?: string | Array<string> | RegExp;
  caption?: string | Array<string> | RegExp;
  tags?: string | Array<string> | RegExp | null;
}

interface TypedDb {
  [key: string]: any,
  posts: MultipleQueries<Post, InsertPost, WherePost>,
  post: SingularQueries<Post, InsertPost, WherePost, number>,
  begin(): Promise<void>,
  commit(): Promise<void>,
  rollback(): Promise<void>,
